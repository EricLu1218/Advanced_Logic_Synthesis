...
#define LEDA_ROOT_INCL_ID 520391
...
private:
  int ymd; // the representation of the date
    ...
    // language data
    static leda_mutex mutex_language;
...
*/
    ...
    // input format
    static leda_mutex mutex_i_fmt;
    static format i_fmt;
    static string i_fmt_str;
    static slist<int> i_fmt_tokens;

    // output format
    static leda_mutex mutex_o_fmt;
    static format o_fmt;
...
public:
  ...
  { if(!d.read(i)) error_handler(1,"date: bad input from stream"); return i; } 
