...
// $Revision: 1.9 $  $Date: 2007/02/28 07:44:14 $

#if !defined(LEDA_ROOT_INCL_ID)
#define LEDA_ROOT_INCL_ID 520232
...
*/
  ...
  { 
    ...
    //cout << string("maxflow = %12.0f",f) << endl;
