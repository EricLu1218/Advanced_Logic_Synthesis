...
// $Revision: 1.8 $  $Date: 2007/02/28 07:44:14 $

#ifndef _LEDA_MAX_FLOW_T
#define _LEDA_MAX_FLOW_T

#if !defined(LEDA_ROOT_INCL_ID)
#define LEDA_ROOT_INCL_ID 520222
...
int compute_dist1(const graph& G, node* V, node s, node t,
                   ...
                   level_queue& U,
                   int* count, 
                   curr_array& current, bool filter=true)
{ 
  // compute exact distance values by a "backward" bfs in the
  // residual network starting at t
...
*/
  ...
  compute_dist1(G,V,s,t,cap,flow,excess,dist,U,count,current,false);
