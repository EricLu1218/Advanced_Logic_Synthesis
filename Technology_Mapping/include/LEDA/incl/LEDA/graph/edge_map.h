...
#define LEDA_ROOT_INCL_ID 520256
...
if (!use_edge_data(G,E())) error_handler(1,"edge_map: no slot available");
}
edge_map(const graph_t& G, const E& x) {
if (!use_edge_data(G,x)) error_handler(1,"edge_map: no slot available");
}
