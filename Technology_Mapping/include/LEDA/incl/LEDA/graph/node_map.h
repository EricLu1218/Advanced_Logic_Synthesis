...
#define LEDA_ROOT_INCL_ID 520307
...
if (!use_node_data(G,E())) error_handler(1,"node_map: no slot available");
}
node_map(const graph_t& G, const E& x) {
if (!use_node_data(G,x)) error_handler(1,"node_map: no slot available");
}
