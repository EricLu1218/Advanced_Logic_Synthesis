...
// $Revision: 1.2 $  $Date: 2007/02/25 00:48:39 $
...
inline edge_struct* node_struct::first_adj_edge(int i) const { return FirstAdjEdge[i]; }
inline edge_struct* node_struct::last_adj_edge(int i)  const { return LastAdjEdge[i]; }
...
inline edge_struct* First_Inout_Edge(node_struct* v, int& i) 
...
/*
inline edge_struct* Succ_Inout_Edge(edge_struct* e, int& i) 
{ edge_struct* x = 0;
  if (e)
  { x = e->succ_adj_edge(i);
...
inline edge_struct* Succ_Inout_Edge(edge_struct* e, node_struct* v, int& i) 
{ edge_struct* x = 0;
  if (e)
