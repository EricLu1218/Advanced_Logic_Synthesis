...
#define LEDA_ROOT_INCL_ID 520258
...
public:
  ...
  if (_g!=nil) error_handler(501,"Iterator: leda::graph already initialized\n");
#endif
...
void reset() {
#if !defined(LEDA_CHECKING_OFF)
  if (_g==nil) error_handler(502,"Iterator: leda::graph not initialized\n");
#endif
  _g->remove(_n,this);
...
void insert() {
#if !defined(LEDA_CHECKING_OFF)
  if (_g==nil) error_handler(504,"Iterator: insert(..), leda::graph not initialized\n");
#endif
  _g->remove(_n,this);
...
void del() {
#if !defined(LEDA_CHECKING_OFF)
  if (_g==nil) error_handler(503,"Iterator: del(), leda::graph not initialized\n");
#endif
  if (valid()) {
    leda::node temp(_n);
    next_node();
...
#if !defined(LEDA_CHECKING_OFF)
    if (_g!=nil) error_handler(501,"Circulators: leda::graph already initialized\n");
#endif
...
void reset() {
#if !defined(LEDA_CHECKING_OFF)
  if (_g==nil) error_handler(502,"Circulators: leda::graph not initialized\n");
#endif
  _e=_g->first_adj_edge(_n); }

void insert(leda::node v1, leda::node v2) {
#if !defined(LEDA_CHECKING_OFF)
  if (_g==nil) error_handler(504,"Circulators: insert(..), leda::graph not initialized\n");
#endif
...
void del() {
#if !defined(LEDA_CHECKING_OFF)
  if (_g==nil) error_handler(503,"Circulators: del(), leda::graph not initialized\n");
#endif
...
const leda::graph& get_graph() const {
#if !defined(LEDA_CHECKING_OFF)
  if (_g==nil) error_handler(502,"Iintrator: leda::graph not initialized\n");
#endif
  return *_g; }
...
#if !defined(LEDA_CHECKING_OFF)
  if (i_handler==nil) error_handler(512,"Data Accessor: leda::node leda::array not initialized\n");
#endif
  return *i_handler; }
...
#if !defined(LEDA_CHECKING_OFF)
  if (i_handler!=nil) error_handler(511,"Data Accessor: leda::node leda::array already initialized\n");
#endif
  i_handler=&na; }
/*{Bounds |\Mvar| to |na|. }*/
...
#if !defined(LEDA_CHECKING_OFF)
  if (i_handler==nil) error_handler(512,"Data Accessor: leda::edge leda::array not initialized\n");
#endif
  return *i_handler; }
...
#if !defined(LEDA_CHECKING_OFF)
  if (i_handler!=nil) error_handler(511,"Data Accessor: leda::edge leda::array already initialized\n");
#endif
  i_handler=&ea; }
...
#if !defined(LEDA_CHECKING_OFF)
  if (i_handler==nil) error_handler(512,"Data Accessor: leda::node leda::map not initialized\n");
#endif
  return *i_handler; }
...
#if !defined(LEDA_CHECKING_OFF)
  if (i_handler!=nil) error_handler(511,"Data Accessor: leda::node leda::map already initialized\n");
#endif
  i_handler=&na; }
...
#if !defined(LEDA_CHECKING_OFF)
  if (i_handler==nil) error_handler(512,"Data Accessor: leda::edge leda::map not initialized\n");
#endif
  return *i_handler; }
...
#if !defined(LEDA_CHECKING_OFF)
  if (i_handler!=nil) error_handler(511,"Data Accessor: leda::edge leda::map already initialized\n");
#endif
  i_handler=&ea; }
...
Ptr& internal_ptr()  {
#if !defined(LEDA_CHECKING_OFF)
  if (initialized==false) error_handler(512,"Data Accessor: member ptr not initialized\n");
#endif
  return _ptr; }
...
void init(Ptr ptr) {
#if !defined(LEDA_CHECKING_OFF)
  if (initialized==true) error_handler(512,"Data Accessor: member ptr already initialized\n");
#endif
