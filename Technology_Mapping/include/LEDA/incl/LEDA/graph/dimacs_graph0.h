...
#define LEDA_ROOT_INCL_ID 520272
...
{  
  ...
  virtual void clear_node_data(void*& data){ error_handler(1,"base node arc"); }
  virtual void clear_arc_data(void*& data) { error_handler(1,"base clear arc");}
