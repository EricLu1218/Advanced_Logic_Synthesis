...
#define LEDA_ROOT_INCL_ID 520264
...
protected:
  ...
  void parse_line(char* line, int& cur_arc);
...
public:
  ...
  { 
    ...
    if (special_nodes().length() != 2)
      error_handler(1,"read_dimacs_mf: wrong number of node lines.");
