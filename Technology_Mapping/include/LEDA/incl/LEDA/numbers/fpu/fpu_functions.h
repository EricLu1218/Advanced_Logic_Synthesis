...
// $Revision: 1.6 $  $Date: 2007/02/25 00:49:24 $
...
#if defined(sparc) || (defined(i386) && !defined(sun)) || defined(__amd64) || defined(__win64__) || defined(mips) || defined(alpha) || defined(hppa) || (defined(powerpc) && defined(__GNUC__)) 
