...
// $Revision: 1.5 $  $Date: 2007/02/28 07:44:15 $

#ifndef LEDA_GRAPHWIN_H
#define LEDA_GRAPHWIN_H

#if !defined(LEDA_ROOT_INCL_ID)
#define LEDA_ROOT_INCL_ID 520019
...
#define A_EDGE      (1 << 9)
#define A_FRAME     (1 << 10)
#define A_SLIDER    (1 << 11)
#define A_IMMEDIATE (1 << 12)
#define A_STOP      (1 << 13)
#define A_MASK      (A_STOP-1)

#define A_NODE_MENU (1 << 14)
#define A_EDGE_MENU (1 << 15)
...
void zoom_to_point(point,point);
...
{ if (win_p->is_open()) 
    error_handler(0,"gw.add_help_text() must be called before gw.display().");
...
friend void gw_maxflow(GraphWin& gw);
friend void gw_maxflowS(GraphWin& gw);
...
void gw_maxflow(GraphWin& gw);
void gw_maxflowS(GraphWin& gw);
