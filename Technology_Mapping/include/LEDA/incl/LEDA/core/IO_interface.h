...
#define LEDA_ROOT_INCL_ID 520527
...
void write_table(const string& mes, double T,
                         string mes2 = "")           {}
void write_table(const string& mes, int T,
                         string mes2 = "")           {}
...
void write_demo(int k, const string& mes, double T, 
                        string mes2 = "")
{ while (k-- > 0) cout << "\n";
...
void write_demo(int k, const string& mes, int T, 
                        string mes2 = "")
{ while (k-- > 0) cout << "\n";
 cout << break_lines(mes) << " " << T << " " << break_lines(mes2); 
 cout.flush();
